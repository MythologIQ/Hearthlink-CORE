...
| Requirement | Status | Evidence |
|-------------|--------|----------|
| Adversarial audit | OK PASS | `commands/ql-audit.md` is explicitly adversarial |
...
|-------|--------|----------|
| Clear directory structure | OK PASS | commands/agents/, commands/, hooks/, templates/, docs/ |
