...
def find_failsafe_root(start: Path) -> Path:
    """Find repo root containing qorelogic/Claude/manifest.json."""
    ...
    raise FileNotFoundError("Could not locate qorelogic/Claude/manifest.json. Run from a FailSafe workspace.")
...
def main() -> int:
    ...
    print(f"Installed QoreLogic Claude bundle to {target} ({scope} scope)")
