...
Read: .claude/commands/ql-governor-persona.md
...
| plans/plan-*.md or plan-*.md | [OK / Missing] | [date or N/A] |
...
If a `plan-*.md` exists, summarize the most recent plan name and phase count if available.  
If no plan exists and the work is non-trivial, recommend creating one:

```
Status: [FOUND / MISSING]
Plan File: [plan-*.md or N/A]
Directive: [If missing -> Run /ql-plan to create a phased implementation plan]
```
