...
This runbook documents chaos engineering practices for the GG-CORE runtime, including blast radius analysis, recovery procedures, and pre-planned game day scenarios.
